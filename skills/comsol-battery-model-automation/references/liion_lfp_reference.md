...
> 实测案例(MIC 1175Ah, LFP/Gr): 现有 SOC 窗口开路电压只覆盖 [2.82V, 3.51V];充电充到端子 3.65V、放电放到端子 2.5V,端子窗口比开路窗口两头都宽,导致放电(1242Ah) > 充电(1173Ah) 差 ~6%。用 3.65V 反解 SOC=100% 会得到正极 stoich = −0.088(非物理),证明 3.65V 不可作开路端点。
