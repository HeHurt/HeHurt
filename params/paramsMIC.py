...
def get_hithium_params(t_factor=1,temperature=298.15):
    ...
    hithium_params = build_lfp_cell_params(temperature, {
        # 电池几何参数
        "Negative electrode thickness [m]": 9.435e-05,
        "Separator thickness [m]": 1.1e-05,
        "Positive electrode thickness [m]": 9.501e-05,
        "Negative particle radius [m]": 5.5e-6  ,
        "Positive particle radius [m]": 4.5e-7,
        "Electrode height [m]": 0.557,
        "Electrode width [m]": 0.1955*82.5*2*2,
        
        # 电池容量参数
        "Nominal cell capacity [A.h]": 1175,
        "Maximum concentration in negative electrode [mol.m-3]": 29094,
        "Maximum concentration in positive electrode [mol.m-3]": 20042,
        
        # 电极结构参数
        "Positive electrode porosity": 0.269813983 ,
        "Positive electrode active material volume fraction": 0.711201181 ,
        "Negative electrode porosity":0.415484812 ,
        "Negative electrode active material volume fraction": 0.5652 ,
