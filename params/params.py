...
def get_hithium_params(t_factor=1,temperature=298.15):
    ...
    cracking_rate_Ai2020 = build_cracking_rate(t_factor, base_rate=0.0)
    ...
    hithium_params = build_lfp_cell_params(temperature, {
        ...
        "Electrode height [m]": 14.56682,
        "Electrode width [m]": 0.1875* 2*2,
        ...
        # 电极结构参数
        "Positive electrode porosity": 0.26426,
        "Positive electrode active material volume fraction": 0.7225,
        "Negative electrode porosity": 0.29065,
        "Negative electrode active material volume fraction": 0.69658,
        'Separator porosity': 0.38,
        
        # 初始条件
        "Initial concentration in negative electrode [mol.m-3]": 707.47,
