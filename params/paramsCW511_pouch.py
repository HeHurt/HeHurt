...
def get_hithium_params(t_factor=1, temperature=298.15):
    ...
    hithium_params = build_lfp_cell_params(temperature, {
        ...
        "Positive electrode thickness [m]": 1.3165250951324644e-04,
        ...
        # 电极结构参数
        "Positive electrode porosity": 0.27752293572184883,
        "Positive electrode active material volume fraction": 0.7087500000568663,
        "Negative electrode porosity": 0.317743165706482,
        "Negative electrode active material volume fraction": 0.663835899767593,
