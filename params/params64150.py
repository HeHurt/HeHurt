...
def get_hithium_params(t_factor=1,temperature=298.15):
    ...
    hithium_params = build_lfp_cell_params(temperature, {
        # 电池几何参数
        "Negative electrode thickness [m]": 6E-5,
        "Positive electrode thickness [m]": 6.9E-5,
        "Separator thickness [m]": 1.6e-05,
        "Negative particle radius [m]": 4.54E-6 ,
        "Positive particle radius [m]": 4.2E-7 ,
        "Electrode height [m]": 0.126,
        "Electrode width [m]":  9.2015*2.1,
        "Cell volume [m3]": 0.0733*0.6*0.2124,  # 双面电极
        ...
        # 电极结构参数
        "Positive electrode porosity": 0.31703,
        "Positive electrode active material volume fraction":0.66385 ,
        "Negative electrode porosity": 0.37396-0.02,
        "Negative electrode active material volume fraction":0.60538 ,
        ...
        "SEI partial molar volume [m3.mol-1]": 0.00009645*1.5 ,
        "Negative electrode LAM constant proportional term [s-1]":1e-7 * t_factor*2 ,
        ...
        "SEI growth activation energy [J.mol-1]": 50000 * .7,
