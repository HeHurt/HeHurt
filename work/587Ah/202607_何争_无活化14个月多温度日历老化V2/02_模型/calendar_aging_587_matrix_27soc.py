...
def _decorate_metrics(
    ...
    *,
    ...
    result["storage_soc_pct"] = STORAGE_SOC_PCT
...
def _write_checkpoints(
    ...
    if metric_frames:
        ...
        metrics.to_csv(
            artifacts_dir / "calendar_aging_587Ah_27SOC_matrix.csv",
            index=False,
            encoding="utf-8-sig",
        )
...
def build_reports(
    ...
    *,
    ...
    csv_path = artifacts_dir / "calendar_aging_587Ah_27SOC_matrix.csv"
    ...
    workbook_path = (
        artifacts_dir
        / "587Ah_0to50C_27SOC_calendar_aging_14months.xlsx"
    )
    with pd.ExcelWriter(workbook_path, engine="openpyxl") as writer:
        ...
        ).to_excel(writer, sheet_name="SOC_loss_pct")
        _pivot_percent(
            metrics,
