...
SCRIPT = Path(r"D:\Users\hez\Desktop\hithium\COMSOL\runs\20260818_cw363_mesh_rebuild\inspect_mesh.py")
MANIFEST = SCRIPT.with_name("inspect_mesh.session.json")
