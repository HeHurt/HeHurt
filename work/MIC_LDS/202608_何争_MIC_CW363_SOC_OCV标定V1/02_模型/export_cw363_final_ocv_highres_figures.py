...
RESULT_DIR = Path(
    r"C:\HithiumSSD\hithium\BatteryProject\output\runs\cw363_soc_ocv"
    r"\20260907_151752_final_ocv_smooth"
)
...
def main():
    ...
    fig.suptitle("CW363 Static SOC–OCV: Final-OCV Smooth Calibration", fontsize=19)
    combined_path = OUTPUT_DIR / "CW363_SOC_OCV_final_smooth_25C_45C_highres.png"
