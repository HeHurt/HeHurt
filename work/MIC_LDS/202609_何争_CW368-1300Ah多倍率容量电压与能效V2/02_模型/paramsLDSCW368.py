"""PyBaMM parameter set for the CW368 1300 Ah LFP cell.
...
RATED_CAPACITY_AH = 1300.0
SINGLE_ELECTRODE_HEIGHT_M = 0.2135
...
def get_hithium_params(
    ...
    """Return CW368-1300Ah overrides with the physical 213.5 mm geometry."""
    ...
    return build_lfp_cell_params(
        temperature,
        {
            # Geometry: CW368 1300 Ah design with a 213.5 mm single-sheet
            # height and otherwise unchanged electrode parameters.
