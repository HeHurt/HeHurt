---
title: PyBaMM 电压磁滞建模全解：三种实现、控制方程与参数接口
author: 何争
digest: 从电流切换到状态记忆，系统讲清 PyBaMM 三种电压磁滞模型的方程、接口、参数和适用边界。
cover: ../03_输入数据/pybamm_hysteresis_cover.png
---
...
![OCP 磁滞插值方程](../03_输入数据/equations/01_ocp_interpolation.png)
...
![Current sigmoid 磁滞状态方程](../03_输入数据/equations/02_current_sigmoid.png)
...
![方向相关的磁滞转换参数](../03_输入数据/equations/03_directional_gamma.png)

当前版本源码实际求解的状态方程为：

![One-state hysteresis 控制方程](../03_输入数据/equations/04_one_state_ode.png)
...
![局部嵌锂脱锂速率尺度](../03_输入数据/equations/05_local_rate_scale.png)
...
![局部差分容量方程](../03_输入数据/equations/06_differential_capacity.png)

再让磁滞转换速率随差分容量变化：

![差分容量磁滞转换速率](../03_输入数据/equations/07_dch_gamma.png)
...
![磁滞产热方程](../03_输入数据/equations/08_hysteresis_heat.png)

并把它加入总产热：

![总产热方程](../03_输入数据/equations/09_total_heat.png)
