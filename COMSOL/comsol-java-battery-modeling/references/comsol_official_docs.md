...
> 用户已提供 COMSOL 6.4 本地文档路径。AI 在 Autonomous Mode 自主 debug 时,如果错误模式库覆盖不了,**主动检索**官方文档。
...
| 文件 | 路径 | 内容 |
|---|---|---|
| **ProgrammingReferenceManual** | `D:\Program Files\COMSOL\COMSOL64\Multiphysics\doc\pdf\COMSOL_Multiphysics\COMSOL_ProgrammingReferenceManual.pdf` | 编程流程、Java API 使用范式、批处理、Method Editor |
| **ReferenceManual** | `D:\Program Files\COMSOL\COMSOL64\Multiphysics\doc\pdf\COMSOL_Multiphysics\COMSOL_ReferenceManual.pdf` | 命令/对象/接口完整参考 (注意:用户原始路径列了两次 ProgrammingReferenceManual,推断第二个应为此文件) |

### 1.2 Javadoc HTML 文档

| 入口 | 路径 |
|---|---|
| **总索引** | `D:\Program Files\COMSOL\COMSOL64\Multiphysics\doc\help\wtpwebapps\ROOT\doc\com.comsol.help.comsol\api\index.html` |
| **ModelUtil 入口类** | `D:\Program Files\COMSOL\COMSOL64\Multiphysics\doc\help\wtpwebapps\ROOT\doc\com.comsol.help.comsol\api\com\comsol\model\util\ModelUtil.html` |
...
pdftotext -layout \
    "D:\Program Files\COMSOL\COMSOL64\Multiphysics\doc\pdf\COMSOL_Multiphysics\COMSOL_ProgrammingReferenceManual.pdf" \
...
DOC="D:\Program Files\COMSOL\COMSOL64\Multiphysics\doc\help\wtpwebapps\ROOT\doc\com.comsol.help.comsol\api"
